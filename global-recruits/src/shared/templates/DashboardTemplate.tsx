    ...
    return (
        <div className="font-custom h-full min-h-screen relative">
            ...
            <div className={"transition-all bottom-0 top-0 transition-slowest ease fix-ios fixed " + (sidebarOpen ? "w-1/3 landscape:w-1/6 sm:w-1/8 md:w-1/6" : "w-0")}>
                <div className="absolute right-[-40px] top-0 h-full lg:hidden">
                    <button className="w-10 h-10 gradient-theme-inverse flex justify-center items-center border-b border-r border-t border-gray-350" onClick={() => setSidebarOpen(!sidebarOpen)}>
