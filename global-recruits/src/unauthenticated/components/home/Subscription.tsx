...
export default function Subscription(props: { type: "basic" | "global", children: any, price: string }) {
    return (
        <div className={"flex flex-col w-full sm:w-1/2 lg:w-1/3 mx-0 sm:mx-4 my-4 sm:my-0 rounded-lg " + (props.type === "global" ? "gradient-theme" : "bg-white")} >
            ...
            <div className="text-center py-8">
                <Button text="COMING SOON" fontSizeClass="md 2xl:text-lg" color={props.type === "basic" ? "gradient" : "black"} />
            </div>
        </div>
    );
}