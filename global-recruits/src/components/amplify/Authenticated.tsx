...
export default function Authenticated(props: any) {
    return (
        <div className="gradient-noimg">
            <section className=" font-custom text-black mx-4 sm:mx-0">
                <div className="h-full min-h-screen flex items-center justify-center flex-wrap m-auto">
                    <Authenticator components={components} services={services} loginMechanisms={['email']}>
