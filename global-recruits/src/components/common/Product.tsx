...
export default function Product(props: { type: "basic" | "global", children: any, price: string, }) {
    return (
        <div className={"block mx-auto border border-black rounded-lg p-4 mb-12 " + (props.type === "global" ? "gradient-text text-white" : "bg-white")}>
            ...
            <div className="py-2">
                {props.type === "basic"
                    ? <div className="flex justify-center">
                        <svg className="w-12 mx-2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <svg className="w-12 mx-2" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    : props.type === "global"
                        ? <div className="flex justify-center">
                            <svg className="w-12 mx-2" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="white" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <svg className="w-12 mx-2" viewBox="0 0 71 55" fill="white" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
            ...
            <div className="flex justify-between flex-col">
                <div className="my-2 text-lg text-wrap">
                    {props.children}
                </div>
