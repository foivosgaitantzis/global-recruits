...
export function setViewStatePage(viewState: ViewState, viewPage: number): ViewState {
    return {
        ...viewState,
        viewPage
    }
...
export function getViewStatePage(viewState: ViewState): number | undefined {
    return viewState.viewPage
}