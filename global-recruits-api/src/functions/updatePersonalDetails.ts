...
/**
 * Update Member (Me) Azure Function
 */
const updatePersonalDetailsFunction: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    // Schema Validation
    const requestBody: UpdateAthleteDetailsRequestBody | UpdateStaffDetailsRequestBody = req.body;
    const pathSchema = getOpenApiPath("/@me", "patch");
...
export default updatePersonalDetailsFunction;