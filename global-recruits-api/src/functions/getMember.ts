...
/**
 * Get Member Info Azure Function
 */
const getMemberFunction: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    // Schema Validation
...
export default getMemberFunction;